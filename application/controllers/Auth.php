...
class Auth extends CI_Controller
{
    ...
    {   
        ...
        if($this->form_validation->run() == false) {
            ...
            Congratulation,your account has been creted. please activate your account!
            </div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'nianurafisah@gmail.com';  //isi dengan email admin
        $config['smtp_pass'] = 'eqickhnergsxnekz'; //password email admin
        ...
        $this->email->from('nianurafisah@gmail.com', 'nia nur afisah');
